...
CREATE TABLE `coupons` (
  ...
  `description` text COLLATE utf8mb4_general_ci,
  `discount_type` enum('percentual','fixo') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `orders` (
  ...
  `status` enum('Pendente','Pago','Enviado','Entregue','Cancelado','Reembolsado') COLLATE utf8mb4_general_ci DEFAULT 'Pendente',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `payments` (
  ...
  `method` enum('Cartão','Boleto','Pix','Transferência') COLLATE utf8mb4_general_ci NOT NULL,
  `status` enum('Aguardando','Pago','Falhou','Reembolsado') COLLATE utf8mb4_general_ci DEFAULT 'Aguardando',
...
CREATE TABLE `shipping_logs` (
  ...
  `tracking_code` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `order_id` (`order_id`),
  CONSTRAINT `shipping_logs_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `shipping_logs` WRITE;
/*!40000 ALTER TABLE `shipping_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `shipping_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `users` (
  ...
  `role` enum('cliente','admin') COLLATE utf8mb4_general_ci DEFAULT 'cliente',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-06-02 21:51:42
